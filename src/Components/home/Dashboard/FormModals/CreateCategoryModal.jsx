...
export default function CreateCategoryModal() {
    ...
    const submitData = async (value) => {
        ...
        const res = await Axios.post('/category/create', { ...value, description, mainCategory, subCategory })
        ...
        if (res?.data?.ok == true) {
            ...
            await queryClient.refetchQueries({ queryKey: ['getCategories'] })
    ...
    const {data} = useQuery(['getParentCategories'], async () => {
        const res = await Axios.get('/category/get_parent_categories')
        return res?.data
    })

    return (
        <>
            <Button onClick={hasBusiness() ? onOpen : businessNotFound} colorScheme={'teal'} variant='outline' size={'sm'}>Create Category</Button>
