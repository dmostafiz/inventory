import { Box, Button, Flex, FormControl, FormErrorMessage, FormHelperText, FormLabel, Input, Select, SimpleGrid, useDisclosure, useToast } from '@chakra-ui/react'
...
export default function UpdateBusiness({ business }) {
    ...
    const submitNow = async (value) => {
        const res = await Axios.post('/business/update', { ...value })
